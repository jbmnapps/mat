...
export const divisionOpgaver: Opgave[] = [
  ...
  },
  {
    ...
    svar: 35,
    forklaring: 'Tip: divider med 10 to gange — cifrene rykker mod højre.',
  },
  {
    id: 'div-07',
    type: 'numeric',
    ...
    svar: 5,
    forklaring: 'Tip: hvilket tal i 7-tabellen ligger lige under 38?',
  },
  {
    id: 'div-08',
    type: 'numeric',
    ...
    svar: 2,
    forklaring: 'Tip: find største multiplum af 6 under 50, og se hvor langt der er op til 50.',
  },
  {
    id: 'div-09',
    type: 'numeric',
